...
func (x *CteateUserRequest) Reset() {
	*x = CteateUserRequest{}
...
func (x *CteateUserRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CteateUserRequest) ProtoMessage() {}

func (x *CteateUserRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_create_user_proto_msgTypes[0]
...
// Deprecated: Use CteateUserRequest.ProtoReflect.Descriptor instead.
func (*CteateUserRequest) Descriptor() ([]byte, []int) {
	return file_rpc_create_user_proto_rawDescGZIP(), []int{0}
}

func (x *CteateUserRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *CteateUserRequest) GetFullName() string {
	if x != nil {
		return x.FullName
	}
	return ""
...
func (x *CteateUserRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *CteateUserRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7e, 0x0a, 0x11, 0x43, 0x74, 0x65, 0x61, 0x74,
	...
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x69, 0x63,
	0x65, 0x6f, 0x6e, 0x2f, 0x67, 0x6f, 0x2d, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2d, 0x62, 0x61,
...
var file_rpc_create_user_proto_goTypes = []interface{}{
	(*CteateUserRequest)(nil),  // 0: pb.CteateUserRequest
...
func file_rpc_create_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_create_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CteateUserRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
